...
export class BrowseEvents {
  ...
  constructor() {
    ...
    this.trigger$
      .pipe(
        switchMap(({ page, searchTerm, categoryId, sortDirection }) => {
          this.loading.set(true);
          const filter: EventFilter = { page, size: this.pageSize, sortDirection };
    ...
    this.trigger$.next({ page: 0, searchTerm: '', sortDirection: 'ASC' });
